...
*1.1. Hãy kể tên các pha cơ bản trong vòng đời phát triển hệ thống (SDLC)? Hãy giải thích mối quan hệ giữa các khái niệm pha, bước, kỹ thuật và sản phẩm?*
...
*1.4. Mô tả các bước chính trong pha phân tích. Các sản phẩm chính của pha này là gì ?*
...
*1.5. Mô tả các bước chính trong pha thiết kế. Các sản phẩm chính của pha này là gì ?*
...
*1.6. Mô tả các bước chính trong pha thực hiện. Các sản phẩm chính của pha này là gì ?*
...
*1.8. Khái niệm thiết lập từng bước có nghĩa như thế nào trong ngữ cảnh SDLC ?*
...
*1.9. So sánh các hệ phương pháp tập trung vào tiến trình và tập trung vào dữ liệu?*
...
~~*1.10. So sánh các hệ phương pháp thiết kế có cấu trúc và các hệ phương pháp RAD?*
...
*1.13. Mô tả các thành phần chính và nhược điểm của phương pháp song song?*
...
*1.14. Mô tả các thành phần chính và nhược điểm của phương pháp phát triển theo pha?*
...
*1.15. Mô tả các thành phần chính và nhược điểm của phương pháp dựa trên nguyên mẫu?*
...
*1.16. Mô tả các thành phần chính và nhược điểm của phương pháp dựa trên nguyên mẫu vứt bỏ?*
...
*1.22. Mục đích chính của những biểu đồ cấu trúc là gì? Hãy kể tên các loại biểu đồ cấu trúc?*
...
*1.23. Những biểu đồ hành vi được sử dụng để làm gì? Hãy kể tên các loại biểu đồ hành vi?*
...
*1.24. Vì sao lấy kiến trúc làm trung tâm (architecture centric) là quan trọng đối với phương pháp phân tích và thiết kế hướng đối tượng (OOSAD)?*
...
*1.29. So sánh vai trò của người phân tích hệ thống, người phân tích kinh tế và người phân tích hạ tầng?*
...
*4.4. Ba bước cơ bản của quá trình phân tích là gì ? Bước nào là đơn giản nhất? vì sao ?*
...
*4.6. So sánh phân tích vấn đề và phân tích nguồn gốc. Áp dụng phân tích vấn đề trong hoàn cảnh nào ? phân tích nguồn gốc trong hoàn cảnh nào ?*
...
*4.8. Giả sử chi phí và thời gian không phải những yếu tố quan trọng, dự án BPR có thu được lợi ích từ việc sử dụng thêm thời gian để hiểu hệ thống đang có ? Tại sao có hoặc tại sao không ?*
...
*4.9. Các tiêu trí quan trọng để lựa chọn chiến lược phân tích yêu cầu phù hợp là gì?*
...
*4.11. Giải thích sự khác biệt giữa các dạng câu hỏi closed-ended, open-ended, và probing. Khi nào thì sử dụng dạng câu hỏi nào?*
...
*4.12. Giải thích sự khác biệt giữa phỏng vấn có cấu trúc và phi cấu trúc. Mỗi kiểu phỏng vấn phù hợp cho tình huống nào?*
...
*4.13. Giải thích sự khác biệt giữa phương pháp phỏng vấn top-down và bottom-up. Bạn nên sử dụng phương pháp nào trong trường hợp nào?*
...
*4.14. Lựa chọn đối tượng phỏng vấn và thành viên cho phiên JAD như thế nào?*
...
*4.20. Giải thích sự khác biệt trong thiết kế câu hỏi cho mục đích khảo sát và thiết kế câu hỏi cho phỏng vấn và phiên JAD?*
...
*4.21. Tỉ lệ phản hồi phổ biến đối với khảo sát là bao nhiêu và bạn có thể cải thiện tỉ lệ này bằng cách nào?*
...
*4.23. Hệ thống thiết kế (formal system) và hệ thống thực (real, informal) khác nhau như thế nào? Ý nghĩa của việc đối chiếu hệ thống thực với hệ thống thiết kế là gì?*
...
*4.24. Các khía cạnh chính của việc sử dụng quan sát trong quá trình thu thập thông tin?*
...
*5.3. Sự khác biệt giữa một hoạt động (activity) và một hành động (action) là gì?*
...
*5.8. Vẽ biều đồ ca sử dụng liên quan như thế nào đến mô hình hóa chức năng ?*
...
*5.9. Hãy giải thích các thuật ngữ sau : (a) tác nhân ; (b) ca sử dụng ; (c) đường biên hệ thống ; (d) mối quan hệ?*
...
*5.10. Mỗi liên kết loại association phải kết nối một ……… và một …….. Tại sao ?*
...
*5.16. Trình bày các bước trong hướng dẫn tạo mô tả luồng sự kiện cho ca sử dụng?*
...
*5.17. Vì sao chúng ta chỉ cố gắng có từ ba đến chín ca sử dụng trong một quy trình nghiệp vụ ?*
...
*5.22. Trình bày các bước trong hướng dẫn thiết lập tập ca sử dụng? Lấy hai ví dụ quan hệ mở rộng (extend) và hai ví dụ quan hệ bao gồm (include)?*
...
*5.23. Những gì trong danh sách sau có thể là tác nhân trên biểu đồ ca sử dụng? Vì sao ?*
Ms. Mary Smith
Nhân Viên
Khách Hàng
Mr. John Seals
...
5.25. Chúng ta sử dụng quá trình nào để ước lượng chi phí phát triển hệ thống dựa trên ca sử dụng?~~
...
*6.4. Hãy so sánh các thuật ngữ sau: đối tượng, lớp, trường hợp (instance), thuộc tính, phương thức, lớp cha, lớp con, lớp cụ thể, lớp trừu tượng?*
...
*6.5. Cho ba ví dụ thuộc tính suy diễn có thể tồn tại trên một biểu đồ lớp. Những thuộc tính này được ký hiệu như thế nào trên biểu đồ lớp?*
...
*6.6. Hãy kể tên các kiểu giới hạn truy cập khác nhau ? Những kiểu giới hạn truy cập này được ký hiệu như thế nào trên biểu đồ lớp ?*
...
*6.7. Hãy vẽ các mối quan hệ mô tả các luật sau. Bao gồm cả số lượng trên các mối quan hệ ?*
...
*6.9. Lớp liên quan (association class) được sử dụng trong biểu đồ lớp cho mục đích gì ? Lấy một ví dụ một lớp liên quan có thể tìm thấy trong biểu đồ lớp chứa thông tin về sinh viên và khóa học mà họ đã tham gia?*
...
*6.10. Hãy lấy hai ví dụ  về các mối quan hệ có liên quan, tổng hợp và khái quát hóa. Mỗi loại quan hệ được biểu diễn như thế nào trong biểu đồ lớp ?*
...
*6.11. Xác định các thao tác sau là hàm tạo, truy vấn và cập nhật . Thao tác nào không cần thiết phải đưa ra trong khung biểu diễn lớp ?*
Tính employee raise ()
Tính số ngày ốm ()
...
*7.2. Một ca sử dụng liên quan như thế nào đến biểu đồ trình tự? Biểu đồ giao tiếp?*
...
*7.3. Hãy so sánh và phân biệt các thuật ngữ sau: Trạng thái (trạng thái) <-> hành vi (behavior); lớp (class) <-> đối tượng (object); hành động (action) <-> hoạt động (activity); ca sử dụng (use case) <-> kịch bản (scenario);  phương thức (method) <-> thông điệp (message)?*
...
*7.5. Các thành phần chính để xây dựng biểu đồ trình tự là gì? Những thành phần này được biểu diễn như thế nào trên mô hình?*
![figures/75.jpg](https://github.com/bangoc/CheatSheetPTTKHT/blob/master/figures/75.JPG)
*7.6. Thể hiện kết thúc sự tồn tại của một đối tượng tạm thời trên biểu đồ trình tự như thế nào?*
Đặt dấu X ở cuối đường sống của một đối tượng tạm thời để đánh dấu thời điểm hủy đối tượng.
*7.7. Đường sống (lifeline) của đối tượng có luôn được kéo dài đến hết trang của biều đồ trình tự không ? Vì sao?*
...
*7.9. Hãy mô tả các thành phần cơ bản của biểu đồ giao tiếp (communication diagram) và giải thích cách biểu diễn những thành phần này trên biểu đồ?*
![figures/79.jpg](https://github.com/bangoc/CheatSheetPTTKHT/blob/master/figures/79.JPG)
*7.10. Trình tự của các thông điệp được thể hiện như thế nào trên biểu đồ giao tiếp?*
Trình tự của thông điệp được thể hiện bằng số thứ tự đặt trước tên thông điệp.
*7.11. Chiều của thông điệp được thể hiện như thế nào trên biểu đồ giao tiếp?*
...
*7.13. Có phải trạng thái luôn được biểu diễn bằng hình vuông góc tròn trên biểu đồ máy trạng thái? Giải thích?*
![figures/713.jpg](https://github.com/bangoc/CheatSheetPTTKHT/blob/master/figures/713.JPG)
*7.14. Các trường hợp nào có thể dẫn tới sự chuyển trạng thái trên biểu đồ trạng thái?*
...
*7.17. Mô tả các kiểu lớp cần được thể hiện bằng biểu đồ trạng thái. Hãy lấy ví dụ hai lớp phù hợp để biểu diễn bằng biểu đồ trạng thái và liệt kê các trạng thái của những lớp đó?*
...
*7.19. Xác định các mô hình chứa mỗi thành phần sau:?*
...
*8.1. Sự khác biệt cơ bản giữa mô hình phân tích và mô hình thiết kế là gì?*
...
*8.2. Tổng duyệt (walkthrough) là gì? Nó ảnh hưởng như thế nào đến xác minh (verification) và xác nhận (validation)?*
...
*8.3. Những vai trò mà các thành viên có thể đảm nhận trong suốt tổng duyệt là gì? Mục đích của những vai trò này là gì?*
...
*8.4. Các mối quan hệ trong mô hình chức năng, mô hình cấu trúc và mô hình hành vi cần kiểm tra là gì?*
...
*8.5. Ý nghĩa của việc cân bằng các mô hình phân tích là gì?*
...
*8.6. Các mối quan hệ giữa những mô hình chức năng, mô hình cấu trúc và mô hình hành vi cần được kiểm tra trong quá trình cân bằng mô hình là gì?*
...
*8.7. Factoring có nghĩa là gì? Nó liên quan đến abstraction và refinement như thế nào ?*
...
*8.8. Phân hoạch là gì ? Phân hoạch liên quan như thế nào đến cộng tác ?*
...
*8.9. Tầng (layer) là gì ? Hãy kể tên các tầng khác nhau?*
...
*8.10. Gói là gì ? Gói liên quan như thế nào đến phân hoạch và tầng?*
...
*8.11. Mối quan hệ phụ thuộc là gì ? Bạn xác định những mối quan hệ đó như thế nào ?*
...
*8.12. Kể tên năm bước để xác định gói và thiết lập biểu đồ gói?*
...
*8.13. Cần kiểm tra những gì trong biểu đồ gói?*
...
*8.14. Tình huống nào là thích hợp nhất để sử dụng chiến lược phát triển ứng dụng mới (custom development design)?*
...
*8.15. Các vấn đề đối với sử dụng gói phần mềm sẵn có để xây dựng hệ thống mới? Có những phương hướng giải quyết nào cho những vấn đề này?*
...
*8.16. Vì sao các công ty đầu tư vào hệ thống ERP?*
...
*8.17. Các ưu nược điểm sử dụng workaround là gì?*
...
*8.18. Vì sao outsourcing được coi là chiến lược thiết kế tốt? Khi nào thì không phù hợp?*
...
*8.19. Các sự khác biệt giữa dạng hợp đồng outsource: thời gian và thu xếp, giá cứng và value-added là gì?*
...
*8.20. Alternative matrix và phân tích tính khả thi liên quan như thế nào?*
...
*8.21. RFP là gì? Khác với RFI như thế nào?*
...
*10.1. Kể tên bốn bước thiết kế lưu trữ đối tượng (dữ liệu)?*
...
~~10.2. Một tệp và một CSDL khác nhau như thế nào?~~
*10.3. Sự khác biệt giữa một hệ quản trị CSDL cá nhân và hệ quản trị CSDL doanh nghiệp là gì? Lấy một ví dụ cho mỗi loại?*
...
~~10.4. Sự khác biệt giữa tệp truy cập tuần tự và tệp truy cập ngẫu nhiên là gì?
10.5. Liệt kê năm loại tệp chính và mô tả mục đích chính của mỗi loại?~~
*10.6. Loại CSDL phổ biến nhất hiện nay là gì? Cung cấp ba ví dụ những sản phẩm dựa trên công nghệ CSDL này?*
...
*10.7. Referential integrity là gì và nó được thực hiện như thế nào trong RDBMS?*
...
~~10.8. Liệt kê một vài sự khác biệt giữa ORDBMS và RDBMS?
...
10.9. Ưu điểm sử dụng ORDMBS so với RDBMS là gì?
...
10.10. Liệt kê một vài sự khác biệt giữa ORDBMS và OODBMS?
OODBMS (Object oriented database management system) hỗ trợ một vài kiểu kế thừa.
10.11. Ưu điểm của ORDBMS so với OODBMS là gì?
10.12. Ưu điểm sử dụng OODBMS so với RDBMS là gì?
10.13. Ưu điểm sử dụng OODBMS so với ORDBMS là gì?~~
*10.14. Kể tên các tiêu trí lựa chọn định dạng lưu trữ dữ liệu?*
...
*10.15. Vì sao bạn cần xét đến định dạng lưu trữ dữ liệu đang sử dụng khi quyết định lựa chọn định dạng lưu trữ mới?*
...
~~10.16. Khi triển khai một dạng lưu trữ trong ORDBMS, các nhóm vấn đề phải giải quyết là gì?
10.17. Khi triển khai một dạng lưu trữ trong RDBMS, các dạng vấn đề cần giải quyết là gì?
10.18. Kể tên ba cách biểu diễn giá trị null trong CSDL quan hệ?~~
*10.19. Hai chiều hướng tối ưu hóa CSDL quan hệ là gì?*
...
*10.20. Mục đích chuẩn hóa là gì?*
...
*10.21. Mô hình thỏa mãn các yêu cầu của ba dạng chuẩn hóa có những đặc điểm gì?*
...
*10.22. Mô tả ba tình huống khi gỡ chuẩn hóa sẽ tốt hơn?*
...
~~10.23. Mô tả một vài kỹ thuật có thể cải thiện hiệu năng của CSDL?
10.24. Sự khác biệt giữa phân tán interfile và intrafile là gì?
10.25. Chỉ mục là gì và chỉ mục có thể cải thiện hiệu năng của hệ thống bằng cách nào ?
10.26. Mô tả các nhân tố cần tính đến khi ước lượng kích thước CSDL ?
10.27. Vì sao việc hiểu quy mô ban đầu và kết thúc của CSDL trong quá trình thiết kế lại quan trọng ?
10.28. Kể tên một vài yêu cầu phi chức năng có thể ảnh hưởng thiết kế lớp quản lý CSDL ?
10.29. Vấn đề chính trong quyết định sử dụng CSDL chuẩn hóa và CSDL không chuẩn hóa là gì ?~~
*10.30. Mục đích sử dụng chính của các lớp truy xuất và xử lý dữ liệu là gì (data access and manipulation classes)?*
...
~~10.31. Vì sao các lớp truy xuất và thay đổi dữ liệu cần phải phụ thuộc vào các lớp liên quan đến vấn đề của lĩnh vực thay vì các phương án khác ?
10.32. Vì sao lưu trữ dữ liệu nên phụ thuộc vào các lớp liên quan đến vấn đề thuộc lĩnh vực tương ứng thay vì các phương án khác ?~~
